    ...
    <>
      <section className="career01-top_cycle js-fix_header">
        <div className="career01-top_cycle_wrapper career01-container">
          <div className="career01-top_cycle_about">
            ...
            <Image className="career01-top_cycle_about_border_pink_left c-bg_pink_border_03"
        ...
        <div className="career01-top_cycle_point">
          <div className="career01-top_cycle_point_wrapper career01-container">
            <h3 className="career01-top_cycle_point_ttl c-ttl">
            ...
            <ul className="career01-top_cycle_point_list_wrapper">
              <li className="career01-top_cycle_point_list js-flow is-active">
                <span className="career01-top_cycle_point_list_number career01-list_ttl_icn_small"><span
                  className="l-features_detail_list_number_txt career01-list_ttl_icn_small_txt">POINT</span>1</span>
                ...
                <a href=""
                  className="career01-top_cycle_point_list_link c-hover_bg_arrow">さくらさくみらいの保育<span className="c-arrow_bg"><span
              ...
              <li className="career01-top_cycle_point_list js-flow is-active">
                <span className="career01-top_cycle_point_list_number career01-list_ttl_icn_small"><span
                  className="l-features_detail_list_number_txt career01-list_ttl_icn_small_txt">POINT</span>2</span>
                <div className="career01-top_cycle_point_list_img_wrapper js-flow_item">
                  <Image className="career01-top_cycle_point_list_img"
                ...
                <a href=""
                  className="career01-top_cycle_point_list_link c-hover_bg_arrow">働きやすい環境づくり<span className="c-arrow_bg"><span
                    className="c-arrow_icn"> <svg viewBox="0 0 14 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M8 1L13 6L8 11" stroke="var(--colorBrown)" strokeLinecap="round"
                        strokeLinejoin="round"></path>
                      <path d="M1 6L13 6" stroke="var(--colorBrown)" strokeLinecap="round" strokeLinejoin="round">
              ...
              <li className="career01-top_cycle_point_list js-flow is-active">
                <span className="career01-top_cycle_point_list_number career01-list_ttl_icn_small"><span
                  className="l-features_detail_list_number_txt career01-list_ttl_icn_small_txt">POINT</span>3</span>
                <div className="career01-top_cycle_point_list_img_wrapper js-flow_item">
                  <Image className="career01-top_cycle_point_list_img"
                ...
                <div className="career01-top_cycle_point_list_link_position">
                  <button className="career01-top_cycle_point_list_link c-hover_bg_arrow js-select_btn">福利厚生・社宅・研修<span
                  ...
                  <ul className="career01-top_cycle_point_list_link_child c-select js-select">
              ...
              <li className="career01-top_cycle_point_list js-flow is-active">
                <span className="career01-top_cycle_point_list_number career01-list_ttl_icn_small"><span
                  className="l-features_detail_list_number_txt career01-list_ttl_icn_small_txt">POINT</span>4</span>
                <div className="career01-top_cycle_point_list_img_wrapper js-flow_item">
                  <Image className="career01-top_cycle_point_list_img"
                ...
                <a href=""
                  className="career01-top_cycle_point_list_link c-hover_bg_arrow">サポート・ケア<span className="c-arrow_bg"><span
                    className="c-arrow_icn"> <svg viewBox="0 0 14 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M8 1L13 6L8 11" stroke="var(--colorBrown)" strokeLinecap="round"
                        strokeLinejoin="round"></path>
                      <path d="M1 6L13 6" stroke="var(--colorBrown)" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="career01-top_link">
        <div className="career01-top_link_wrapper career01-container">
          ...
          <Image className="career01-top_link_illust c-illust_teature_01" src={p_illust_teacher01}
            alt="" />
        </div>
